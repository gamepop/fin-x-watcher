...
export default function LiveStreamFeed({
  ...
  return (
    <div className="fixed right-0 top-16 bottom-0 w-[380px] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-l border-slate-700/50 shadow-2xl z-30 flex flex-col">
      {/* Header */}
